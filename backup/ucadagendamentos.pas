...
begin
  ...
  DataModuleF.QRYAgendamentos.sql.Add('SELECT * FROM AGENDAMENTO WHERE LOWER(MEDICO) LIKE :pConsulta');
  ...
  //DataModuleF.QRYAgendamentos.SQL.Add(
  //     'SELECT * '+
  //     'FROM AGENDAMENTO '+
  //     'WHERE LOWER(MEDICO) = :pConsulta');
end;
